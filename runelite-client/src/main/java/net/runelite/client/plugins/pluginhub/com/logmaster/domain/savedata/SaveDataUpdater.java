package net.runelite.client.plugins.pluginhub.com.logmaster.domain.savedata;
...
import net.runelite.client.plugins.pluginhub.com.logmaster.domain.savedata.v0.V0SaveData;
import net.runelite.client.plugins.pluginhub.com.logmaster.domain.savedata.v0.V0Task;
import net.runelite.client.plugins.pluginhub.com.logmaster.domain.savedata.v0.V0TaskPointer;
import net.runelite.client.plugins.pluginhub.com.logmaster.domain.savedata.v1.V1SaveData;
import net.runelite.client.plugins.pluginhub.com.logmaster.domain.savedata.v1.V1TaskPointer;
import net.runelite.client.plugins.pluginhub.com.logmaster.domain.savedata.v2.V2SaveData;
import net.runelite.client.plugins.pluginhub.com.logmaster.task.SaveDataStorage;
