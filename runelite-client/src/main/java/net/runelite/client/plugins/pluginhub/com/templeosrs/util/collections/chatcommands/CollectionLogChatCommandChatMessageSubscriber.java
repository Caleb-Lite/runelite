package net.runelite.client.plugins.pluginhub.com.templeosrs.util.collections.chatcommands;

import net.runelite.client.plugins.pluginhub.com.templeosrs.util.collections.chatcommands.commands.DisplayPlayerCollectionLogChatCommand;
import net.runelite.client.plugins.pluginhub.com.templeosrs.util.collections.chatcommands.commands.ListAllBossCategoriesChatCommand;
import net.runelite.client.plugins.pluginhub.com.templeosrs.util.collections.chatcommands.commands.ListAllCluesCategoriesChatCommand;
import net.runelite.client.plugins.pluginhub.com.templeosrs.util.collections.chatcommands.commands.ListAllCustomCategoriesChatCommand;
import net.runelite.client.plugins.pluginhub.com.templeosrs.util.collections.chatcommands.commands.ListAllHelpCommandsChatCommand;
import net.runelite.client.plugins.pluginhub.com.templeosrs.util.collections.chatcommands.commands.ListAllMinigamesCategoriesChatCommand;
import net.runelite.client.plugins.pluginhub.com.templeosrs.util.collections.chatcommands.commands.ListAllOtherCategoriesChatCommand;
import net.runelite.client.plugins.pluginhub.com.templeosrs.util.collections.chatcommands.commands.ListAllRaidsCategoriesChatCommand;
