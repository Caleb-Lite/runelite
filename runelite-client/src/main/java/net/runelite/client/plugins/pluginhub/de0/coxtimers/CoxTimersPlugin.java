package net.runelite.client.plugins.pluginhub.de0.coxtimers;

import com.google.inject.Provides;
import net.runelite.client.plugins.pluginhub.de0.util.CoxUtil;
import net.runelite.client.plugins.pluginhub.de0.util.MiscUtil;
