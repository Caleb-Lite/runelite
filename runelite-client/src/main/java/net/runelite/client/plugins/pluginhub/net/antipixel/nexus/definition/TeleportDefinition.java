package net.runelite.client.plugins.pluginhub.net.antipixel.nexus.definition;

import lombok.Getter;
import net.runelite.client.plugins.pluginhub.net.antipixel.nexus.IntegerBooleanPair;
