package net.runelite.client.plugins.pluginhub.com.catimer;

import net.runelite.client.plugins.pluginhub.com.catimer.config.HesporiTimes;
import net.runelite.client.plugins.pluginhub.com.catimer.config.VorkathTimes;
import net.runelite.client.plugins.pluginhub.com.catimer.config.ZulrahTimes;
import net.runelite.client.plugins.pluginhub.com.catimer.config.HydraTimes;
