package net.runelite.client.plugins.pluginhub.com.RuneLingual;

import com.RuneLingual.ApiTranslate.*;
import com.RuneLingual.ChatMessages.*;
import net.runelite.client.plugins.pluginhub.com.RuneLingual.MouseOverlays.MenuEntryHighlightOverlay;
import net.runelite.client.plugins.pluginhub.com.RuneLingual.MouseOverlays.MouseTooltipOverlay;
import net.runelite.client.plugins.pluginhub.com.RuneLingual.SQL.SqlActions;
import net.runelite.client.plugins.pluginhub.com.RuneLingual.SQL.SqlQuery;
import net.runelite.client.plugins.pluginhub.com.RuneLingual.Widgets.PartialTranslationManager;
import net.runelite.client.plugins.pluginhub.com.RuneLingual.Widgets.Widget2ModDict;
import net.runelite.client.plugins.pluginhub.com.RuneLingual.Widgets.WidgetCapture;
import net.runelite.client.plugins.pluginhub.com.RuneLingual.Widgets.WidgetsUtilRLingual;
import net.runelite.client.plugins.pluginhub.com.RuneLingual.commonFunctions.FileNameAndPath;
import net.runelite.client.plugins.pluginhub.com.RuneLingual.debug.OutputToFile;
import com.RuneLingual.nonLatin.*;
import net.runelite.client.plugins.pluginhub.com.RuneLingual.prepareResources.H2Manager;
import net.runelite.client.plugins.pluginhub.com.RuneLingual.prepareResources.SpriteReplacer;
...
import net.runelite.client.plugins.pluginhub.com.RuneLingual.SidePanelComponents.SidePanel;
import net.runelite.client.plugins.pluginhub.com.RuneLingual.commonFunctions.FileActions;
import net.runelite.client.plugins.pluginhub.com.RuneLingual.prepareResources.Downloader;
import net.runelite.client.plugins.pluginhub.com.RuneLingual.commonFunctions.Ids;
