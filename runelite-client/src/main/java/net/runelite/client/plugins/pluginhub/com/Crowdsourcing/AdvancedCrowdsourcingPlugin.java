...
import net.runelite.client.plugins.pluginhub.com.Crowdsourcing.animation.CrowdsourcingAnimation;
import net.runelite.client.plugins.pluginhub.com.Crowdsourcing.clues.CrowdsourcingClues;
import net.runelite.client.plugins.pluginhub.com.Crowdsourcing.dialogue.CrowdsourcingDialogue;
import net.runelite.client.plugins.pluginhub.com.Crowdsourcing.doom_of_mokhaiotl.CrowdsourcingDoomOfMokhaiotl;
import net.runelite.client.plugins.pluginhub.com.Crowdsourcing.experience.CrowdsourcingExperience;
import net.runelite.client.plugins.pluginhub.com.Crowdsourcing.inventory.CrowdsourcingInventory;
import net.runelite.client.plugins.pluginhub.com.Crowdsourcing.item_sighting.CrowdsourcingItemSighting;
import net.runelite.client.plugins.pluginhub.com.Crowdsourcing.messages.CrowdsourcingMessages;
import net.runelite.client.plugins.pluginhub.com.Crowdsourcing.mlm.CrowdsourcingMLM;
import net.runelite.client.plugins.pluginhub.com.Crowdsourcing.monster_examine.MonsterExamine;
import net.runelite.client.plugins.pluginhub.com.Crowdsourcing.npc_sighting.CrowdsourcingNpcSighting;
import net.runelite.client.plugins.pluginhub.com.Crowdsourcing.npc_respawn.CrowdsourcingNpcRespawn;
import net.runelite.client.plugins.pluginhub.com.Crowdsourcing.overhead_dialogue.CrowdsourcingOverheadDialogue;
import net.runelite.client.plugins.pluginhub.com.Crowdsourcing.playerkit.CrowdsourcingPlayerkit;
import net.runelite.client.plugins.pluginhub.com.Crowdsourcing.pottery.CrowdsourcingPottery;
import net.runelite.client.plugins.pluginhub.com.Crowdsourcing.pyramid_plunder.CrowdsourcingPyramidPlunder;
import net.runelite.client.plugins.pluginhub.com.Crowdsourcing.quest_log.CrowdsourcingQuestLog;
import net.runelite.client.plugins.pluginhub.com.Crowdsourcing.respawns.Respawns;
import net.runelite.client.plugins.pluginhub.com.Crowdsourcing.scenery.CrowdsourcingScenery;
import net.runelite.client.plugins.pluginhub.com.Crowdsourcing.shootingstars.CrowdsourcingStars;
import net.runelite.client.plugins.pluginhub.com.Crowdsourcing.toa.CrowdsourcingTombs;
import net.runelite.client.plugins.pluginhub.com.Crowdsourcing.varbits.CrowdsourcingVarbits;
import net.runelite.client.plugins.pluginhub.com.Crowdsourcing.impling.CrowdsourcingImpling;
