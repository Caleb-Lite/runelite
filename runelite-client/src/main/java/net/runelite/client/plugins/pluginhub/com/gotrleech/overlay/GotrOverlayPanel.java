package net.runelite.client.plugins.pluginhub.com.gotrleech.overlay;

import net.runelite.client.plugins.pluginhub.com.gotrleech.GotrGameState;
import net.runelite.client.plugins.pluginhub.com.gotrleech.GotrLeechConfig;
import net.runelite.client.plugins.pluginhub.com.gotrleech.GotrLeechPlugin;
import net.runelite.client.plugins.pluginhub.com.gotrleech.GotrPlayerState;
import net.runelite.client.plugins.pluginhub.com.gotrleech.item.GotrItemManager;
...
public class GotrOverlayPanel extends OverlayPanel {
    ...
    public Dimension render(Graphics2D graphics) {
        ...
        int requiredEnergy = config.customPointRequirement();
