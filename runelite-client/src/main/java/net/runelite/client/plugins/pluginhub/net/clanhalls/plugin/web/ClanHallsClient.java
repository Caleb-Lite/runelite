package net.runelite.client.plugins.pluginhub.net.clanhalls.plugin.web;

import net.runelite.client.plugins.pluginhub.net.clanhalls.plugin.ClanHallsConfig;
import net.clanhalls.plugin.beans.*;
import com.google.gson.Gson;
import lombok.extern.slf4j.Slf4j;
import net.runelite.client.plugins.pluginhub.net.clanhalls.plugin.beans.Credentials;
import okhttp3.*;
