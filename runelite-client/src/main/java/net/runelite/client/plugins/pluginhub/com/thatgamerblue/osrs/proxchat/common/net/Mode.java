package net.runelite.client.plugins.pluginhub.com.thatgamerblue.osrs.proxchat.common.net;

import net.runelite.client.plugins.pluginhub.com.esotericsoftware.kryo.Kryo;
import net.runelite.client.plugins.pluginhub.com.esotericsoftware.kryonet.Client;
import net.runelite.client.plugins.pluginhub.com.esotericsoftware.kryonet.Connection;
import net.runelite.client.plugins.pluginhub.com.esotericsoftware.kryonet.EndPoint;
import net.runelite.client.plugins.pluginhub.com.esotericsoftware.kryonet.Listener;
import net.runelite.client.plugins.pluginhub.com.esotericsoftware.kryonet.Server;
import net.runelite.client.plugins.pluginhub.com.thatgamerblue.osrs.proxchat.common.net.messages.c2s.C2SAuth;
import net.runelite.client.plugins.pluginhub.com.thatgamerblue.osrs.proxchat.common.net.messages.c2s.C2SMicPacket;
import net.runelite.client.plugins.pluginhub.com.thatgamerblue.osrs.proxchat.common.net.messages.c2s.C2SUpdatePacket;
import net.runelite.client.plugins.pluginhub.com.thatgamerblue.osrs.proxchat.common.net.messages.s2c.S2CAuthReq;
import net.runelite.client.plugins.pluginhub.com.thatgamerblue.osrs.proxchat.common.net.messages.s2c.S2CKillDecoder;
import net.runelite.client.plugins.pluginhub.com.thatgamerblue.osrs.proxchat.common.net.messages.s2c.S2CMicPacket;
import net.runelite.client.plugins.pluginhub.com.thatgamerblue.osrs.proxchat.common.net.messages.s2c.S2CUpdateReq;
import net.runelite.client.plugins.pluginhub.com.thatgamerblue.osrs.proxchat.common.serializers.ByteArySerializer;
import net.runelite.client.plugins.pluginhub.com.thatgamerblue.osrs.proxchat.common.serializers.UUIDSerializer;
