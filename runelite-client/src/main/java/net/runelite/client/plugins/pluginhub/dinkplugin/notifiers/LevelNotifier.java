...
import net.runelite.client.plugins.pluginhub.dinkplugin.notifiers.data.LevelNotificationData;
import net.runelite.client.plugins.pluginhub.dinkplugin.notifiers.data.XpNotificationData;
