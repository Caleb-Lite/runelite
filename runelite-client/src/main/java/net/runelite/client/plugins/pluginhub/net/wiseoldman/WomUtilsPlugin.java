...
import net.runelite.client.plugins.pluginhub.net.wiseoldman.beans.CanvasCompetition;
import net.runelite.client.plugins.pluginhub.net.wiseoldman.beans.Competition;
import net.runelite.client.plugins.pluginhub.net.wiseoldman.beans.NameChangeEntry;
import net.runelite.client.plugins.pluginhub.net.wiseoldman.beans.ParticipantWithStanding;
import net.runelite.client.plugins.pluginhub.net.wiseoldman.beans.GroupMembership;
import net.runelite.client.plugins.pluginhub.net.wiseoldman.beans.ParticipantWithCompetition;
import net.runelite.client.plugins.pluginhub.net.wiseoldman.events.WomGroupSynced;
import net.runelite.client.plugins.pluginhub.net.wiseoldman.events.WomOngoingPlayerCompetitionsFetched;
import net.runelite.client.plugins.pluginhub.net.wiseoldman.events.WomRequestFailed;
import net.runelite.client.plugins.pluginhub.net.wiseoldman.events.WomUpcomingPlayerCompetitionsFetched;
import net.runelite.client.plugins.pluginhub.net.wiseoldman.panel.CompetitionCardPanel;
import net.runelite.client.plugins.pluginhub.net.wiseoldman.panel.NameAutocompleter;
import net.runelite.client.plugins.pluginhub.net.wiseoldman.panel.WomPanel;
import net.runelite.client.plugins.pluginhub.net.wiseoldman.ui.CodeWordOverlay;
import net.runelite.client.plugins.pluginhub.net.wiseoldman.ui.CompetitionInfoBox;
import net.runelite.client.plugins.pluginhub.net.wiseoldman.ui.SyncButton;
import net.runelite.client.plugins.pluginhub.net.wiseoldman.util.DelayedAction;
import net.runelite.client.plugins.pluginhub.net.wiseoldman.web.WomRequestType;
import net.runelite.client.plugins.pluginhub.net.wiseoldman.web.WomClient;
import net.runelite.client.plugins.pluginhub.net.wiseoldman.web.WomCommand;
