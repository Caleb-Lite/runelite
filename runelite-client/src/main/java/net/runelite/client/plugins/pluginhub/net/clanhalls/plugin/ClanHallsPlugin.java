package net.runelite.client.plugins.pluginhub.net.clanhalls.plugin;

import net.clanhalls.plugin.beans.*;
import net.runelite.client.plugins.pluginhub.net.clanhalls.plugin.web.APIResponse;
import net.runelite.client.plugins.pluginhub.net.clanhalls.plugin.web.ClanHallsClient;
