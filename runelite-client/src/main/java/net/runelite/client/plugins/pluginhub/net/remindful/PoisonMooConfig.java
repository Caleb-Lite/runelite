package net.runelite.client.plugins.pluginhub.net.remindful;

import net.runelite.client.plugins.pluginhub.net.remindful.enums.config.CureTicksChoice;
import net.runelite.client.plugins.pluginhub.net.remindful.enums.config.ExclaimChoice;
import net.runelite.client.plugins.pluginhub.net.remindful.enums.config.MooVarietyChoice;
import net.runelite.client.plugins.pluginhub.net.remindful.enums.config.TildeChoice;
