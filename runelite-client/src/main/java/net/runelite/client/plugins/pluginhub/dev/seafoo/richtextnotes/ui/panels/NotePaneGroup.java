package net.runelite.client.plugins.pluginhub.dev.seafoo.richtextnotes.ui.panels;

import net.runelite.client.plugins.pluginhub.dev.seafoo.richtextnotes.RichTextNotesConfig;
import net.runelite.client.plugins.pluginhub.dev.seafoo.richtextnotes.models.Note;
import net.runelite.client.plugins.pluginhub.dev.seafoo.richtextnotes.models.NoteMetadata;
import net.runelite.client.plugins.pluginhub.dev.seafoo.richtextnotes.services.FileStorageService;
import net.runelite.client.plugins.pluginhub.dev.seafoo.richtextnotes.services.ItemIconService;
import net.runelite.client.plugins.pluginhub.dev.seafoo.richtextnotes.ui.components.RichTextEditor;
import net.runelite.client.plugins.pluginhub.dev.seafoo.richtextnotes.ui.popups.NoteSelectionDialog;
import net.runelite.client.plugins.pluginhub.dev.seafoo.richtextnotes.ui.popups.TagEditDialog;
