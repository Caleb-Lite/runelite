package net.runelite.client.plugins.pluginhub.com.mjhylkema.TeleportMaps;

import com.google.gson.Gson;
import com.google.inject.Provides;
import net.runelite.client.plugins.pluginhub.com.mjhylkema.TeleportMaps.components.adventureLog.AdventureLogComposite;
import net.runelite.client.plugins.pluginhub.com.mjhylkema.TeleportMaps.components.IMap;
import net.runelite.client.plugins.pluginhub.com.mjhylkema.TeleportMaps.components.adventureLog.MinecartMap;
import net.runelite.client.plugins.pluginhub.com.mjhylkema.TeleportMaps.components.MushtreeMap;
import net.runelite.client.plugins.pluginhub.com.mjhylkema.TeleportMaps.components.adventureLog.SkillsNecklaceMap;
import net.runelite.client.plugins.pluginhub.com.mjhylkema.TeleportMaps.components.adventureLog.SpiritTreeMap;
import net.runelite.client.plugins.pluginhub.com.mjhylkema.TeleportMaps.components.adventureLog.WildernessObeliskMap;
import net.runelite.client.plugins.pluginhub.com.mjhylkema.TeleportMaps.components.adventureLog.XericsMap;
import net.runelite.client.plugins.pluginhub.com.mjhylkema.TeleportMaps.definition.SpriteDefinition;
