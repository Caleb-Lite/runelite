package net.runelite.client.plugins.pluginhub.com.xpdrops.config;

import net.runelite.client.plugins.pluginhub.com.xpdrops.overlay.TextComponentWithAlpha;
