package net.runelite.client.plugins.pluginhub.com.salverrs.RemainingCasts.Infobox;

import net.runelite.client.plugins.pluginhub.com.salverrs.RemainingCasts.Model.SpellCost;
import net.runelite.client.plugins.pluginhub.com.salverrs.RemainingCasts.Model.SpellInfo;
import net.runelite.client.plugins.pluginhub.com.salverrs.RemainingCasts.RemainingCastsConfig;
import net.runelite.client.plugins.pluginhub.com.salverrs.RemainingCasts.Util.CastUtils;
import net.runelite.client.plugins.pluginhub.com.salverrs.RemainingCasts.Util.RuneIds;
