package net.runelite.client.plugins.pluginhub.gg.embargo;

import com.google.inject.Provides;
import gg.embargo.collections.*;
import net.runelite.client.plugins.pluginhub.gg.embargo.commands.CommandManager;
import net.runelite.client.plugins.pluginhub.gg.embargo.eastereggs.NPCRenameManager;
import net.runelite.client.plugins.pluginhub.gg.embargo.manifest.ManifestManager;
import net.runelite.client.plugins.pluginhub.gg.embargo.ui.EmbargoPanel;
import net.runelite.client.plugins.pluginhub.gg.embargo.eastereggs.ItemRenameManager;
import net.runelite.client.plugins.pluginhub.gg.embargo.ui.SyncButtonManager;
import net.runelite.client.plugins.pluginhub.gg.embargo.noticeboard.NoticeBoardManager;
import net.runelite.client.plugins.pluginhub.gg.embargo.untrackables.UntrackableItemManager;
