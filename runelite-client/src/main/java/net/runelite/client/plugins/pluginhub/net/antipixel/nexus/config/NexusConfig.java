package net.runelite.client.plugins.pluginhub.net.antipixel.nexus.config;

import net.runelite.client.plugins.pluginhub.net.antipixel.nexus.ui.BorderStyle;
