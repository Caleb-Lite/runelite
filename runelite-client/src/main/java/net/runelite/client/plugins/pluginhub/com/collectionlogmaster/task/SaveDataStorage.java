package net.runelite.client.plugins.pluginhub.com.collectionlogmaster.task;

import net.runelite.client.plugins.pluginhub.com.collectionlogmaster.CollectionLogMasterConfig;
import com.google.gson.JsonSyntaxException;
import net.runelite.client.plugins.pluginhub.com.collectionlogmaster.domain.savedata.BaseSaveData;
import net.runelite.client.plugins.pluginhub.com.collectionlogmaster.domain.savedata.SaveData;
import net.runelite.client.plugins.pluginhub.com.collectionlogmaster.domain.savedata.SaveDataUpdater;
import net.runelite.client.plugins.pluginhub.com.collectionlogmaster.util.EventBusSubscriber;
import net.runelite.client.plugins.pluginhub.com.collectionlogmaster.util.SimpleDebouncer;
