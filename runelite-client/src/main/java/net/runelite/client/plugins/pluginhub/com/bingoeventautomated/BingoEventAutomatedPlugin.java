package net.runelite.client.plugins.pluginhub.com.bingoeventautomated;

import net.runelite.client.plugins.pluginhub.com.bingoeventautomated.Mapper.ActionDataModel;
import net.runelite.client.plugins.pluginhub.com.bingoeventautomated.Mapper.InventoryActionDataModelMapper;
import net.runelite.client.plugins.pluginhub.com.bingoeventautomated.Mapper.NpcActionDataModelMapper;
import net.runelite.client.plugins.pluginhub.com.bingoeventautomated.config.IEventConfig;
import net.runelite.client.plugins.pluginhub.com.bingoeventautomated.events.PlayerEvent;
import net.runelite.client.plugins.pluginhub.com.bingoeventautomated.service.ActionDataModelClient;
import net.runelite.client.plugins.pluginhub.com.bingoeventautomated.service.DynamicConfigClient;
import net.runelite.client.plugins.pluginhub.com.bingoeventautomated.validator.ActionDataItemValidator;
