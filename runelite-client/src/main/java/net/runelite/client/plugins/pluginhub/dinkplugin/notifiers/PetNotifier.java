...
import net.runelite.client.plugins.pluginhub.dinkplugin.notifiers.data.PetNotificationData;
...
import net.runelite.client.plugins.pluginhub.dinkplugin.util.SerializedLoot;
