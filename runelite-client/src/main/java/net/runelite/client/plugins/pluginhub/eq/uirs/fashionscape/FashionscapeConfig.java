...
import net.runelite.client.plugins.pluginhub.eq.uirs.fashionscape.core.randomizer.RandomizerIntelligence;
import net.runelite.client.plugins.pluginhub.eq.uirs.fashionscape.panel.SortBy;
