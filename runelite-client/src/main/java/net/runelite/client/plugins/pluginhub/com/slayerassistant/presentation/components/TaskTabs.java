package net.runelite.client.plugins.pluginhub.com.slayerassistant.presentation.components;

import net.runelite.client.plugins.pluginhub.com.slayerassistant.domain.Icon;
import net.runelite.client.plugins.pluginhub.com.slayerassistant.domain.Task;
import net.runelite.client.plugins.pluginhub.com.slayerassistant.presentation.components.tabs.TableTab;
import net.runelite.client.plugins.pluginhub.com.slayerassistant.domain.Tab;
import net.runelite.client.plugins.pluginhub.com.slayerassistant.domain.TabKey;
import net.runelite.client.plugins.pluginhub.com.slayerassistant.presentation.components.tabs.TextTab;
import net.runelite.client.plugins.pluginhub.com.slayerassistant.presentation.components.tabs.WikiTab;
