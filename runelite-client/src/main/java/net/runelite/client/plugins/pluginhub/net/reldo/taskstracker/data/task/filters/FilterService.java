package net.runelite.client.plugins.pluginhub.net.reldo.taskstracker.data.task.filters;

import java.util.HashMap;
import javax.inject.Inject;
import javax.inject.Singleton;
import lombok.extern.slf4j.Slf4j;
import net.runelite.client.plugins.pluginhub.net.reldo.taskstracker.data.jsondatastore.FilterDataClient;
