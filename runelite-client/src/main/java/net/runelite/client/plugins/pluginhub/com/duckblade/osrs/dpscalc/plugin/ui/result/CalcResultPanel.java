package net.runelite.client.plugins.pluginhub.com.duckblade.osrs.dpscalc.plugin.ui.result;

import net.runelite.client.plugins.pluginhub.com.duckblade.osrs.dpscalc.calc.AttackSpeedComputable;
import net.runelite.client.plugins.pluginhub.com.duckblade.osrs.dpscalc.calc.defender.DefenseRollComputable;
import net.runelite.client.plugins.pluginhub.com.duckblade.osrs.dpscalc.calc.DpsComputable;
import net.runelite.client.plugins.pluginhub.com.duckblade.osrs.dpscalc.calc.HitChanceComputable;
import net.runelite.client.plugins.pluginhub.com.duckblade.osrs.dpscalc.calc.TimeToKillComputable;
import net.runelite.client.plugins.pluginhub.com.duckblade.osrs.dpscalc.calc.attack.AttackRollComputable;
import net.runelite.client.plugins.pluginhub.com.duckblade.osrs.dpscalc.calc.compute.ComputeContext;
import net.runelite.client.plugins.pluginhub.com.duckblade.osrs.dpscalc.calc.exceptions.DpsComputeException;
import net.runelite.client.plugins.pluginhub.com.duckblade.osrs.dpscalc.calc.exceptions.MissingInputException;
import net.runelite.client.plugins.pluginhub.com.duckblade.osrs.dpscalc.calc.maxhit.BaseMaxHitComputable;
import net.runelite.client.plugins.pluginhub.com.duckblade.osrs.dpscalc.calc.maxhit.TrueMaxHitComputable;
import net.runelite.client.plugins.pluginhub.com.duckblade.osrs.dpscalc.calc.prayer.PrayerDurationRemainingComputable;
import net.runelite.client.plugins.pluginhub.com.duckblade.osrs.dpscalc.plugin.ui.state.PanelStateManager;
import net.runelite.client.plugins.pluginhub.com.duckblade.osrs.dpscalc.plugin.ui.state.StateBoundComponent;
