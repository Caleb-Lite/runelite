package net.runelite.client.plugins.pluginhub.com.notificationpanel.Formatting;

import static com.notificationpanel.Formatting.FormatOption.tryParseAsAny;
import net.runelite.client.plugins.pluginhub.com.notificationpanel.Formatting.FormatOptions.ColorOption;
import net.runelite.client.plugins.pluginhub.com.notificationpanel.Formatting.FormatOptions.DurationOption;
import net.runelite.client.plugins.pluginhub.com.notificationpanel.Formatting.FormatOptions.OpacityOption;
import net.runelite.client.plugins.pluginhub.com.notificationpanel.Formatting.FormatOptions.ShowTimeOption;
import net.runelite.client.plugins.pluginhub.com.notificationpanel.Formatting.FormatOptions.VisibilityOption;
