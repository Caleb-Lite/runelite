...
import net.runelite.client.plugins.pluginhub.dinkplugin.domain.Danger;
...
import net.runelite.client.plugins.pluginhub.dinkplugin.notifiers.data.DeathNotificationData;
...
import net.runelite.client.plugins.pluginhub.dinkplugin.util.Region;
