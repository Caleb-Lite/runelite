package net.runelite.client.plugins.pluginhub.com.example.enemydata.toa;

import net.runelite.client.plugins.pluginhub.com.example.enemydata.Enemy;
import com.example.enemydata.toa.ampken.*;
import net.runelite.client.plugins.pluginhub.com.example.enemydata.toa.crondis.Crocodile;
import net.runelite.client.plugins.pluginhub.com.example.enemydata.toa.crondis.Zebak;
import net.runelite.client.plugins.pluginhub.com.example.enemydata.toa.het.Akkha;
import net.runelite.client.plugins.pluginhub.com.example.enemydata.toa.het.AkkhaShadow;
import com.example.enemydata.toa.scabaras.*;
import com.example.enemydata.toa.wardens.*;
import net.runelite.client.plugins.pluginhub.com.example.utils.QuadFunction;
