...
import net.runelite.client.plugins.pluginhub.com.maxhit.NextMaxHitReqs;
import net.runelite.client.plugins.pluginhub.com.maxhit.equipment.EquipmentFunctions;
import net.runelite.client.plugins.pluginhub.com.maxhit.sets.FullObsidianSet;
import net.runelite.client.plugins.pluginhub.com.maxhit.sets.InquisitorSet;
import net.runelite.client.plugins.pluginhub.com.maxhit.styles.AttackStyle;
import java.util.Collection;
import java.util.Set;
import lombok.extern.slf4j.Slf4j;
import net.runelite.client.plugins.pluginhub.com.maxhit.sets.DharokSet;
import net.runelite.client.plugins.pluginhub.com.maxhit.sets.ObsidianSet;
