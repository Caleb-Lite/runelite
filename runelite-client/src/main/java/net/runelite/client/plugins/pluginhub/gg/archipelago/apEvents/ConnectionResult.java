...
import net.runelite.client.plugins.pluginhub.dev.koifysh.archipelago.events.ConnectionResultEvent;
import net.runelite.client.plugins.pluginhub.gg.archipelago.SlotData;
