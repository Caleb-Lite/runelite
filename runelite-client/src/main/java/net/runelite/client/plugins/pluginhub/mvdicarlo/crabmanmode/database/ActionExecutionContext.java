package net.runelite.client.plugins.pluginhub.mvdicarlo.crabmanmode.database;

import java.util.Map;
import net.runelite.client.plugins.pluginhub.mvdicarlo.crabmanmode.AzureTableApi;
import net.runelite.client.plugins.pluginhub.mvdicarlo.crabmanmode.UnlockedItemEntity;
