package net.runelite.client.plugins.pluginhub.de0.coxthieving;
...
import net.runelite.client.plugins.pluginhub.de0.coxthieving.CoxThievingPlugin.GrubCollection;
