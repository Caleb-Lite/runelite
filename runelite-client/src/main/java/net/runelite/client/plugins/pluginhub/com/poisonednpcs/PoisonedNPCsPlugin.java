package net.runelite.client.plugins.pluginhub.com.poisonednpcs;

import com.google.common.base.Predicates;
import com.google.inject.Provides;
import net.runelite.client.plugins.pluginhub.com.poisonednpcs.combat.Hit;
import net.runelite.client.plugins.pluginhub.com.poisonednpcs.combat.Weapon;
import net.runelite.client.plugins.pluginhub.com.poisonednpcs.health.HitsplatType;
import net.runelite.client.plugins.pluginhub.com.poisonednpcs.health.PoisonWatchTimer;
import net.runelite.client.plugins.pluginhub.com.poisonednpcs.npcs.NPCTrackingService;
import net.runelite.client.plugins.pluginhub.com.poisonednpcs.npcs.NPCUtils;
import net.runelite.client.plugins.pluginhub.com.poisonednpcs.npcs.Opponent;
import net.runelite.client.plugins.pluginhub.com.poisonednpcs.npcs.OpponentCuller;
import net.runelite.client.plugins.pluginhub.com.poisonednpcs.poison.PoisonType;
import net.runelite.client.plugins.pluginhub.com.poisonednpcs.util.ArrayUtils;
