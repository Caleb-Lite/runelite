...
import net.runelite.client.plugins.pluginhub.ch.oldschoolsnit.models.GLTF;
import net.runelite.client.plugins.pluginhub.ch.oldschoolsnit.models.ModelSnapshot;
