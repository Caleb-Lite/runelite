package net.runelite.client.plugins.pluginhub.com.notenoughrunes.config;

import net.runelite.client.plugins.pluginhub.com.notenoughrunes.SourceSectionType;
