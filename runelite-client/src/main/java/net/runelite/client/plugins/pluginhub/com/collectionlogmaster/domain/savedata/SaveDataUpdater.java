package net.runelite.client.plugins.pluginhub.com.collectionlogmaster.domain.savedata;
...
import net.runelite.client.plugins.pluginhub.com.collectionlogmaster.domain.savedata.v0.V0SaveData;
import net.runelite.client.plugins.pluginhub.com.collectionlogmaster.domain.savedata.v0.V0Task;
import net.runelite.client.plugins.pluginhub.com.collectionlogmaster.domain.savedata.v0.V0TaskPointer;
import net.runelite.client.plugins.pluginhub.com.collectionlogmaster.domain.savedata.v1.V1SaveData;
import net.runelite.client.plugins.pluginhub.com.collectionlogmaster.domain.savedata.v1.V1TaskPointer;
import net.runelite.client.plugins.pluginhub.com.collectionlogmaster.domain.savedata.v2.V2SaveData;
import net.runelite.client.plugins.pluginhub.com.collectionlogmaster.task.SaveDataStorage;
import net.runelite.client.plugins.pluginhub.com.collectionlogmaster.task.TaskService;
import net.runelite.client.plugins.pluginhub.com.collectionlogmaster.util.FileUtils;
