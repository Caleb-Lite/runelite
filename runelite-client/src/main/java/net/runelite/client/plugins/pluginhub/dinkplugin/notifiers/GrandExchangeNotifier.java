...
import net.runelite.client.plugins.pluginhub.dinkplugin.notifiers.data.GrandExchangeNotificationData;
...
import net.runelite.client.plugins.pluginhub.dinkplugin.util.SerializedOffer;
