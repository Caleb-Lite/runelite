package net.runelite.client.plugins.pluginhub.bbp.trimmer;

import net.runelite.client.plugins.pluginhub.bbp.trimmer.configs.AbyssalWhipMode;
import net.runelite.client.plugins.pluginhub.bbp.trimmer.configs.DarkBowMode;
import net.runelite.client.plugins.pluginhub.bbp.trimmer.configs.GracefulMode;
import net.runelite.client.plugins.pluginhub.bbp.trimmer.configs.GraniteMaulMode;
import net.runelite.client.plugins.pluginhub.bbp.trimmer.configs.RuneArmourMode;
import net.runelite.client.plugins.pluginhub.bbp.trimmer.configs.RuneScimitarMode;
