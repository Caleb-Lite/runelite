package net.runelite.client.plugins.pluginhub.hootisman.unmutedjingles.jingles;

import net.runelite.client.plugins.pluginhub.hootisman.unmutedjingles.UnmutedJinglesConfig;
import lombok.*;
