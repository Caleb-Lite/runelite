package net.runelite.client.plugins.pluginhub.dinkplugin.notifiers;

import net.runelite.client.plugins.pluginhub.dinkplugin.domain.LootCriteria;
import net.runelite.client.plugins.pluginhub.dinkplugin.message.Embed;
import net.runelite.client.plugins.pluginhub.dinkplugin.message.NotificationBody;
import net.runelite.client.plugins.pluginhub.dinkplugin.message.NotificationType;
import net.runelite.client.plugins.pluginhub.dinkplugin.message.templating.Evaluable;
import net.runelite.client.plugins.pluginhub.dinkplugin.message.templating.Replacements;
import net.runelite.client.plugins.pluginhub.dinkplugin.message.templating.Template;
import net.runelite.client.plugins.pluginhub.dinkplugin.message.templating.impl.JoiningReplacement;
import net.runelite.client.plugins.pluginhub.dinkplugin.notifiers.data.AnnotatedItemStack;
import net.runelite.client.plugins.pluginhub.dinkplugin.notifiers.data.LootNotificationData;
import net.runelite.client.plugins.pluginhub.dinkplugin.notifiers.data.RareItemStack;
import net.runelite.client.plugins.pluginhub.dinkplugin.notifiers.data.SerializedItemStack;
import net.runelite.client.plugins.pluginhub.dinkplugin.util.ConfigUtil;
...
import net.runelite.client.plugins.pluginhub.dinkplugin.util.MathUtils;
import net.runelite.client.plugins.pluginhub.dinkplugin.util.ThievingService;
import net.runelite.client.plugins.pluginhub.dinkplugin.util.RarityService;
import net.runelite.client.plugins.pluginhub.dinkplugin.util.Utils;
import net.runelite.client.plugins.pluginhub.dinkplugin.util.WorldUtils;
