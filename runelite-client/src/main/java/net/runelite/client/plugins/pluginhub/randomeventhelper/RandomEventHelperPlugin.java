package net.runelite.client.plugins.pluginhub.randomeventhelper;
...
import net.runelite.client.plugins.pluginhub.randomeventhelper.randomevents.beekeeper.BeekeeperHelper;
import net.runelite.client.plugins.pluginhub.randomeventhelper.randomevents.drilldemon.DrillDemonHelper;
import net.runelite.client.plugins.pluginhub.randomeventhelper.randomevents.freakyforester.FreakyForesterHelper;
import net.runelite.client.plugins.pluginhub.randomeventhelper.randomevents.gravedigger.GravediggerHelper;
import net.runelite.client.plugins.pluginhub.randomeventhelper.randomevents.maze.MazeHelper;
import net.runelite.client.plugins.pluginhub.randomeventhelper.randomevents.mime.MimeHelper;
import net.runelite.client.plugins.pluginhub.randomeventhelper.randomevents.pinball.PinballHelper;
import net.runelite.client.plugins.pluginhub.randomeventhelper.randomevents.pirate.PirateHelper;
import net.runelite.client.plugins.pluginhub.randomeventhelper.randomevents.sandwichlady.SandwichLadyHelper;
import net.runelite.client.plugins.pluginhub.randomeventhelper.randomevents.quizmaster.QuizMasterHelper;
import net.runelite.client.plugins.pluginhub.randomeventhelper.randomevents.surpriseexam.SurpriseExamHelper;
