...
import net.runelite.client.plugins.pluginhub.rs117.hd.config.AntiAliasingMode;
import net.runelite.client.plugins.pluginhub.rs117.hd.config.ColorBlindMode;
import net.runelite.client.plugins.pluginhub.rs117.hd.config.ColorFilter;
import net.runelite.client.plugins.pluginhub.rs117.hd.config.Contrast;
import net.runelite.client.plugins.pluginhub.rs117.hd.config.DefaultSkyColor;
import net.runelite.client.plugins.pluginhub.rs117.hd.config.DynamicLights;
import net.runelite.client.plugins.pluginhub.rs117.hd.config.FogDepthMode;
import net.runelite.client.plugins.pluginhub.rs117.hd.config.Saturation;
import net.runelite.client.plugins.pluginhub.rs117.hd.config.SceneScalingMode;
...
import net.runelite.client.plugins.pluginhub.rs117.hd.config.ShadowDistance;
import net.runelite.client.plugins.pluginhub.rs117.hd.config.ShadowMode;
import net.runelite.client.plugins.pluginhub.rs117.hd.config.ShadowResolution;
import net.runelite.client.plugins.pluginhub.rs117.hd.config.TextureResolution;
import net.runelite.client.plugins.pluginhub.rs117.hd.config.UIScalingMode;
