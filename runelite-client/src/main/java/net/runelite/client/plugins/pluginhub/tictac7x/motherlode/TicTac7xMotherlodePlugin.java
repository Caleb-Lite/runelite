package net.runelite.client.plugins.pluginhub.tictac7x.motherlode;
...
import net.runelite.client.plugins.pluginhub.tictac7x.motherlode.oreveins.OreVeins;
import net.runelite.client.plugins.pluginhub.tictac7x.motherlode.rockfalls.Rockfalls;
